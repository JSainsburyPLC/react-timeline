...
var Element = function Element(_ref) {
  ...
  var width = parseInt(time.toStyleLeftAndWidth(start, end).width, 10);
  var paddingStyle = width < 20 && { padding: '0 0 0 ' + width + 'px' };
  return _react2.default.createElement(
    ...
    _react2.default.createElement(_Basic2.default, {
      title: title,
      style: (0, _extends3.default)({}, trackStyle, style, paddingStyle)
    })
  );
};
